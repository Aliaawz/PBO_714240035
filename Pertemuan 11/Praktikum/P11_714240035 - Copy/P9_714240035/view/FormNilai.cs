...
// Pastikan baris using controller/model ini sesuai dengan namespace projectmu
// Jika error merah, arahkan mouse ke "controller" lalu klik "Show Potential Fixes" -> "using ..."
using P9_714240035.controller;
using P9_714240035.model;

namespace P9_714240035 // SAYA MENGHAPUS .view DISINI
{
    public partial class FormNilai : Form
    {
        ...
        public void Tampil()
        {
            // Perhatikan spasi di query SQL agar tidak error
        ...
        {
            // Pastikan checkBoxNpm sudah dibuat di Form Design (Name: checkBoxNpm)
        ...
        public void GetNamaMhs()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                // Pastikan textBoxNama sudah dibuat di Form Design (Name: textBoxNama)
